 ...
 _complete$0: function() {
  ...
  try {
    ...
    if (this.get$hasValue() === true) {
      ...
      if (this._exceptionHandled !== true && $.gtB($.get$length(this._successListeners), 0)) throw $.captureStackTrace(t1);
    }
  } finally {
...
$$.HashMapImplementation = {"":
 ...
 forEach$1: function(f) {
  ...
  for (var i = 0; i < length$; ++i) {
    ...
    !(key === (void 0)) && !(key === $.CTC9) && f.$call$2(key, $.index(this._values, i));
  }
 },
 ...
 operator$indexSet$2: function(key, value) {
  ...
  if ($.index(this._lib0_keys, index) === (void 0) || $.index(this._lib0_keys, index) === $.CTC9) this._numberOfEntries = $.add(this._numberOfEntries, 1);
  ...
  switch (state) {
    ...
    case 3:
      ...
      for (var i = 0; $.ltB(i, capacity); ++i) {
        ...
        if (key === (void 0) || key === $.CTC9) continue;
...
$$.LinkedHashMapImplementation = {"":
 ...
 forEach$1: function(f) {
  var t1 = ({});
  t1.f_11 = f;
  $.forEach(this._lib0_list, new $.Closure10(t1));
 },
 remove$1: function(key) {
...
$$.DoubleLinkedQueue = {"":
 ...
 get$first: function() { return new $.Closure14(this, 'first$0'); },
...
$$.FilteredElementList = {"":
 ...
 get$add: function() { return new $.Closure16(this, 'add$1'); },
...
$$.JsonpCallback = {"":
 ["onDataReceived=", "_onMessage?", "_script", "_callbackFunctionName?"],
 super: "Object",
 onDataReceived$1: function(arg0) { return this.onDataReceived.$call$1(arg0); },
 doCallback$2: function(url, onData) {
  var t1 = ({});
  if ($.eqB($.contains$1(url, this._callbackFunctionName), false)) throw $.captureStackTrace('callback url must contain the callback function name!');
  if (!$.eqNullB(onData)) this.onDataReceived = onData;
  var completer = $.CompleterImpl$0();
  $.setRuntimeTypeInfo(completer, ({T: 'Map'}));
  t1.completer_1 = completer;
  this._onMessage = new $.Closure8(this, t1);
 ...
 _removeScriptText$0: function() {
  ...
  this._script.remove$0();
 },
 _addScriptText$0: function() {
  var t1 = this._callbackFunctionName;
  t1 = '        function ' + $.S(t1) + '(s) { \r\n          var messageData = JSON.stringify(s);\r\n          var data = \'{"requestName":"' + $.S(t1) + '","jsonpData":\' + messageData + \'}\';           \r\n          window.postMessage(data, \'*\');\r\n        }\r\n    ';
  this._script.set$text(t1);
 },
 get$callbackFunctionName: function() {
...
$$.Closure = {"":
 ...
 $call$1: function(event$) {
  ...
  var gplusUrl = 'https://www.googleapis.com/plus/v1/activities?query=' + $.S(searchText) + '&pp=1&key=' + $.S(this.gplusApiKey_3) + '&callback=' + $.S(this.box_0.gplusCallback_1.get$callbackFunctionName());
  var twitterUrl = 'http://search.twitter.com/search.json?q=' + $.S(searchText) + '&callback=' + $.S(this.box_0.twitterCallback_2.get$callbackFunctionName());
  this.box_0.gplusCallback_1.doCallback$1(gplusUrl).then$1($._onGPlusDataReceived);
  this.box_0.twitterCallback_2.doCallback$1(twitterUrl);
 }
};
...
$$.Closure8 = {"":
 ...
 $call$1: function(event$) {
  ...
  if ($.eqB($.index(json, 'requestName'), this.this_2.get$_callbackFunctionName())) {
    $.window().get$on().get$message().remove$1(this.this_2.get$_onMessage());
    this.this_2._removeScriptText$0();
    var result = $.index(json, 'jsonpData');
    !$.eqNullB(this.this_2.get$onDataReceived()) && this.this_2.onDataReceived$1(result);
    this.box_0.completer_1.complete$1(result);
  }
 }
};
...
Isolate.$defineClass('Closure14', 'Closure15', ['self', 'target'], {
...
$.getSearchText = function() {
  var searchText = $.document().query$1('#searchText').get$value();
  $.print(searchText);
  return $.startsWith(searchText, '#') === true ? '%23' + $.S($.substring$1(searchText, 1)) : searchText;
};
...
$.buildUiElement = function(title, user, url, image, content$) {
  if ($.eqNullB(content$)) content$ = '';
  return $.Element$html(' <div class=\'result\'><img src=\'' + $.S(image) + '\'><span class=\'itemtitle\'>' + $.S(title) + '</span><br/><span class=\'user\'> by <a href=\'' + $.S(url) + '\' target=\'_blank\'>' + $.S(user) + '</a></span><br/><br/>' + $.S(content$) + '</div>\r\n');
};
...
$.JsonpCallback$1 = function(_callbackFunctionName) {
  var t1 = new $.JsonpCallback((void 0), (void 0), (void 0), _callbackFunctionName);
  t1.JsonpCallback$1(_callbackFunctionName);
  return t1;
};
...
$.main = function() {
  var t1 = ({});
  t1.gplusCallback_1 = $.JsonpCallback$1('gplusFunction');
  t1.twitterCallback_2 = $.JsonpCallback$1('twitterFunction');
  t1.twitterCallback_2.set$onDataReceived($._onTwitterDataReceived);
  $.add$1($.document().get$body().query$1('#searchButton').get$on().get$click(), new $.Closure('AIzaSyDQkKqW-XrUakARo-96vHh1oBbWv50udL4', t1));
};
...
$._onGPlusDataReceived = function(data) {
  $.clear($.document().get$body().query$1('#gplus').get$nodes());
  $.add$1($.document().get$body().query$1('#gplus').get$nodes(), $.Element$html('<p>Google Plus</p>'));
  for (var i = 0; $.ltB(i, $.get$length($.index(data, 'items'))); ++i) {
    var title = $.index($.index($.index(data, 'items'), i), 'title');
    var content$ = $.index($.index($.index($.index(data, 'items'), i), 'object'), 'content');
    var element = $.buildUiElement(title, $.index($.index($.index($.index(data, 'items'), i), 'actor'), 'displayName'), $.index($.index($.index(data, 'items'), i), 'url'), $.index($.index($.index($.index($.index(data, 'items'), i), 'actor'), 'image'), 'url'), content$);
    $.add$1($.document().get$body().query$1('#gplus').get$nodes(), element);
  }
};
...
$._onTwitterDataReceived = function(data) {
  $.clear($.document().get$body().query$1('#twitter').get$nodes());
  $.add$1($.document().get$body().query$1('#twitter').get$nodes(), $.Element$html('<p>Twitter</p>'));
  for (var i = 0; $.ltB(i, $.get$length($.index(data, 'results'))); ++i) {
    var title = $.index($.index($.index(data, 'results'), i), 'text');
    var element = $.buildUiElement('', $.index($.index($.index(data, 'results'), i), 'from_user_name'), 'http://www.twitter.com/#!/' + $.S($.index($.index($.index(data, 'results'), i), 'from_user')), $.index($.index($.index(data, 'results'), i), 'profile_image_url'), title);
    $.add$1($.document().get$body().query$1('#twitter').get$nodes(), element);
  }
};
...
$._onGPlusDataReceived.$call$1 = $._onGPlusDataReceived;
$._onGPlusDataReceived.$name = "_onGPlusDataReceived";
...
$._onTwitterDataReceived.$call$1 = $._onTwitterDataReceived;
$._onTwitterDataReceived.$name = "_onTwitterDataReceived";
